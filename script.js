...
var clutter1 = ""
document.querySelector("#welcome h1").textContent.split("").forEach(function (w) {
  clutter1 += `<span>${w}</span>`
})

document.querySelector("#welcome h1").innerHTML = clutter1
var clutter11 = ""
document.querySelector("#welcome h4").textContent.split("").forEach(function (w) {
  clutter11 += `<span>${w}</span>`
})

document.querySelector("#welcome h4").innerHTML = clutter11
...
function pg3() {
  var clutter = ""
document.querySelector("#page3 h2").textContent.split(" ").forEach(function (w) {
  clutter += `<span> ${w} </span>`
})
...
var clutter2 = ""
document.querySelector("#page3 h4").textContent.split(" ").forEach(function (w) {
  clutter2 += `<span> ${w} </span>`
})

document.querySelector("#page3 h4").innerHTML = clutter2
...
function pg4() {
  var clutter3 = ""
document.querySelector("#page4 h2").textContent.split(" ").forEach(function (w) {
  clutter3 += `<span> ${w} </span>`
})

document.querySelector("#page4 h2").innerHTML = clutter3

var clutter4 = ""
document.querySelector("#page4 h4").textContent.split(" ").forEach(function (w) {
  clutter4 += `<span> ${w} </span>`
})

document.querySelector("#page4 h4").innerHTML = clutter4
...
function canva2() {
  ...
  var clutter6 = ""
  document.querySelector("#over-pg6 h4").textContent.split(" ").forEach(function (w) {
    clutter6 += `<span> ${w} </span>`
  })
  
  document.querySelector("#over-pg6 h4").innerHTML = clutter6
